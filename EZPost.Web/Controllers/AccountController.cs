...
using EZPost.Users;
using EZPost.Web.Controllers.Results;
using EZPost.Web.Models.Account;
...
{
    public class AccountController : EZPostControllerBase
    {
        ...
        [AbpMvcAuthorize]
        public ActionResult TestNotification(string message = "", string severity = "info")
        {
            if (message.IsNullOrEmpty())
            {
                message = "Test Notification, created at " + Clock.Now;
            }

              _notificationAppService.SendMessage(new SendMessageInput
              {
                 Users  = new UserIdentifier[] { AbpSession.ToUserIdentifier() },
                 Message = message,
              });
