$.SaveForm = function (options) {
    ...
    window.setTimeout(function () {
        $.ajax({
            ...
            //                if (XMLHttpRequest.responseJSON.error.validationErrors) {
            //                    dialogMsg(XMLHttpRequest.responseJSON.error.validationErrors[0].message, -1);
            //                } else {
            //                    dialogMsg(XMLHttpRequest.responseJSON.error.message, -1);
            //                }
            //            }
            //        }catch(e){
            //            dialogMsg("系统出现错误", -1);
            ...
            try {
                if (!xhr.responseJSON.success) {
                    if (xhr.responseJSON.error.validationErrors) {
                        dialogMsg(xhr.responseJSON.error.validationErrors[0].message, -1);
                    } else {
                        dialogMsg(xhr.responseJSON.error.message +xhr.responseJSON.error.details, -1);
                    }
                }
            } catch (e) {
                dialogMsg("系统出现错误", -1);
